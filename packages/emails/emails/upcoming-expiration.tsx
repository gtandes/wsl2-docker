...
export const UpcomingExpirationEmail = ({ props = defaultEmailProps }) => {
  ...
  return (
    <BaseAgencyEmail previewText={props.previewText} agency={{ ...props.agency }}>
      ...
      <Text className="text-gray-600">
        ...
        approaching competency expiration dates. Ensuring clinicians remain in compliance is crucial to your success,
        and {"we're"} here to support you in this endeavor.
      </Text>
      <Text className="text-gray-600">
        To view the complete list of clinicians with upcoming expiration dates, please click on the following link:{" "}
...
export default UpcomingExpirationEmail;
