...
const permissions = [
  permission(agency, "junction_sc_definitions_directus_users", "update", rule, {}, "status,reassigned"),
  permission(manager, "junction_sc_definitions_directus_users", "update", rule, {}, "status,reassigned"),
];
