        ...
        <div className="flex flex-col gap-3 sm:mt-8 sm:flex-row">
          ...
          <div className="flex-grow bg-white p-6 shadow">
            {examState.hasError ? (
                      ...
                      >
                        {!imageError ? (
                          <Image
                            src={
                              !imageError
                                ? `${window.origin}/cms/assets/${examState.question.image}?width=480`
                                : BackgroundImg
                            }
                            width={640}
                            height={640}
              ...
              <>
                {loading || examState.saving || examState.retrying ? (
                  <div className="flex justify-center">
                    <Spinner />
                  </div>
                ) : !examState.question ? (
...
export default withAuth(QuestionExam, ClinicianGroup);
