export default function Custom404() {
  // TODO when ACL is working set "Go Back home" to /admin and to /clinician accordingly
  // TODO consider redirecting to /login and detect if the user is logged in to redirect to the main role page (/admin or /clinician)
